...
describe('OS detection', () => {
  ...
  test('should detect OS name', () => {
    uaGetter.mockReturnValue(UA.Chrome91Win10);
    expect(require('../dist').os.name).toBe('windows');
    expect(require('../dist').os.android).toBe(false);
    expect(require('../dist').os.windows).toBe(true);
    expect(require('../dist').os.linux).toBe(false);
    expect(require('../dist').os.mac).toBe(false);
    expect(require('../dist').os.ios).toBe(false);
    expect(require('../dist').os.bot).toBe(false);
    jest.resetModules();
    uaGetter.mockReturnValue(UA.Chrome91macOS);
    expect(require('../dist').os.name).toBe('macos');
    expect(require('../dist').os.android).toBe(false);
    expect(require('../dist').os.windows).toBe(false);
    expect(require('../dist').os.linux).toBe(false);
    expect(require('../dist').os.mac).toBe(true);
    expect(require('../dist').os.ios).toBe(false);
    expect(require('../dist').os.bot).toBe(false);
    jest.resetModules();
    uaGetter.mockReturnValue(UA.Chrome91Linux);
    expect(require('../dist').os.name).toBe('linux');
    expect(require('../dist').os.android).toBe(false);
    expect(require('../dist').os.windows).toBe(false);
    expect(require('../dist').os.linux).toBe(true);
    expect(require('../dist').os.mac).toBe(false);
    expect(require('../dist').os.ios).toBe(false);
    expect(require('../dist').os.bot).toBe(false);
    jest.resetModules();
    uaGetter.mockReturnValue(UA.iPhoneXRSafari);
    expect(require('../dist').os.name).toBe('ios');
    expect(require('../dist').os.android).toBe(false);
    expect(require('../dist').os.windows).toBe(false);
    expect(require('../dist').os.linux).toBe(false);
    expect(require('../dist').os.mac).toBe(false);
    expect(require('../dist').os.ios).toBe(true);
    expect(require('../dist').os.bot).toBe(false);
    jest.resetModules();
    uaGetter.mockReturnValue(UA.SamsungGalaxyS9);
    expect(require('../dist').os.name).toBe('android');
    expect(require('../dist').os.android).toBe(true);
    expect(require('../dist').os.windows).toBe(false);
    expect(require('../dist').os.linux).toBe(false);
    expect(require('../dist').os.mac).toBe(false);
    expect(require('../dist').os.ios).toBe(false);
  ...
  test('should detect OS version', () => {
    uaGetter.mockReturnValue(UA.Chrome91Win10);
    expect(require('../dist').os.version).toBe('NT 10.0');
    expect(require('../dist').os.majorVersion).toBe(10);
    jest.resetModules();
    uaGetter.mockReturnValue(UA.Chrome91macOS);
    expect(require('../dist').os.version).toBe('10.15.7');
    expect(require('../dist').os.majorVersion).toBe(10);
    jest.resetModules();
    uaGetter.mockReturnValue(UA.iPhoneXRSafari);
    expect(require('../dist').os.version).toBe('12.0');
    expect(require('../dist').os.majorVersion).toBe(12);
  });

  test('should detect Bots', () => {
    uaGetter.mockReturnValue(UA.GoogleBot);
    expect(require('../dist').os.bot).toBe(true);
    jest.resetModules();
...
describe('Browser detection', () => {
  ...
  test('should detect browser name', () => {
    uaGetter.mockReturnValue(UA.Chrome91Win10);
    expect(require('../dist').browser.name).toBe('chrome');
    expect(require('../dist').browser.chrome).toBe(true);
    expect(require('../dist').browser.firefox).toBe(false);
    expect(require('../dist').browser.safari).toBe(false);
    expect(require('../dist').browser.opera).toBe(false);
    expect(require('../dist').browser.edge).toBe(false);
    expect(require('../dist').browser.ie).toBe(false);
    jest.resetModules();
    uaGetter.mockReturnValue(UA.Firefox89Win10);
    expect(require('../dist').browser.name).toBe('firefox');
    expect(require('../dist').browser.chrome).toBe(false);
    expect(require('../dist').browser.firefox).toBe(true);
    expect(require('../dist').browser.safari).toBe(false);
    expect(require('../dist').browser.opera).toBe(false);
    expect(require('../dist').browser.edge).toBe(false);
    expect(require('../dist').browser.ie).toBe(false);
    ...
    expect(require('../dist').browser.name).toBe('safari');
    expect(require('../dist').browser.chrome).toBe(false);
    expect(require('../dist').browser.firefox).toBe(false);
    expect(require('../dist').browser.safari).toBe(true);
    expect(require('../dist').browser.opera).toBe(false);
    expect(require('../dist').browser.edge).toBe(false);
    expect(require('../dist').browser.ie).toBe(false);
    jest.resetModules();
    uaGetter.mockReturnValue(UA.Opera77Win10);
    expect(require('../dist').browser.name).toBe('opera');
    expect(require('../dist').browser.chrome).toBe(false);
    expect(require('../dist').browser.firefox).toBe(false);
    expect(require('../dist').browser.safari).toBe(false);
    expect(require('../dist').browser.opera).toBe(true);
    expect(require('../dist').browser.edge).toBe(false);
    expect(require('../dist').browser.ie).toBe(false);
    jest.resetModules();
    uaGetter.mockReturnValue(UA.Edge91Win10);
    expect(require('../dist').browser.name).toBe('microsoft edge');
    expect(require('../dist').browser.chrome).toBe(false);
    expect(require('../dist').browser.firefox).toBe(false);
    expect(require('../dist').browser.safari).toBe(false);
    expect(require('../dist').browser.opera).toBe(false);
    expect(require('../dist').browser.edge).toBe(true);
    expect(require('../dist').browser.ie).toBe(false);
    jest.resetModules();
    uaGetter.mockReturnValue(UA.InternetExplorer11);
    expect(require('../dist').browser.name).toBe('internet explorer');
    expect(require('../dist').browser.chrome).toBe(false);
    expect(require('../dist').browser.firefox).toBe(false);
    expect(require('../dist').browser.safari).toBe(false);
    expect(require('../dist').browser.opera).toBe(false);
    expect(require('../dist').browser.edge).toBe(false);
    expect(require('../dist').browser.ie).toBe(true);
  });

  test('should detect browser version', () => {
    uaGetter.mockReturnValue(UA.Chrome91Win10);
    expect(require('../dist').browser.version).toBe('91.0.4472.77');
    expect(require('../dist').browser.majorVersion).toBe(91);
    jest.resetModules();
    uaGetter.mockReturnValue(UA.Safari14macOS);
    expect(require('../dist').browser.version).toBe('14.0.3');
    expect(require('../dist').browser.majorVersion).toBe(14);
    jest.resetModules();
    uaGetter.mockReturnValue(UA.Firefox89Win10);
    expect(require('../dist').browser.version).toBe('89.0');
    expect(require('../dist').browser.majorVersion).toBe(89);
    jest.resetModules();
    uaGetter.mockReturnValue(UA.Edge91Win10);
    expect(require('../dist').browser.version).toBe('91.0.866.0');
    expect(require('../dist').browser.majorVersion).toBe(91);
    jest.resetModules();
    uaGetter.mockReturnValue(UA.InternetExplorer11);
    expect(require('../dist').browser.version).toBe('11');
    expect(require('../dist').browser.majorVersion).toBe(11);
    jest.resetModules();
    uaGetter.mockReturnValue(UA.iPhoneXRSafari);
    expect(require('../dist').browser.version).toBe('12.0');
    expect(require('../dist').browser.majorVersion).toBe(12);
  });

  test('should detect in-app browsers', () => {
    uaGetter.mockReturnValue(UA.FacebookApp);
    expect(require('../dist').browser.facebook).toBe(true);
    expect(require('../dist').browser.inApp).toBe(true);
    jest.resetModules();
    uaGetter.mockReturnValue(UA.InstagramApp);
    expect(require('../dist').browser.instagram).toBe(true);
    expect(require('../dist').browser.inApp).toBe(true);
    jest.resetModules();
    uaGetter.mockReturnValue(UA.WhatsappApp);
    expect(require('../dist').browser.whatsApp).toBe(true);
    expect(require('../dist').browser.inApp).toBe(true);
    jest.resetModules();
    uaGetter.mockReturnValue(UA.TikTokApp);
    expect(require('../dist').browser.tikTok).toBe(true);
    expect(require('../dist').browser.inApp).toBe(true);
    jest.resetModules();
    uaGetter.mockReturnValue(UA.WechatApp);
    expect(require('../dist').browser.weChat).toBe(true);
    expect(require('../dist').browser.inApp).toBe(true);
    jest.resetModules();
    uaGetter.mockReturnValue(UA.PinterestApp);
    expect(require('../dist').browser.pinterest).toBe(true);
    expect(require('../dist').browser.inApp).toBe(true);
    jest.resetModules();
    uaGetter.mockReturnValue(UA.SnapchatApp);
    expect(require('../dist').browser.snapchat).toBe(true);
    expect(require('../dist').browser.inApp).toBe(true);
    jest.resetModules();
    uaGetter.mockReturnValue(UA.LinkedInApp);
    expect(require('../dist').browser.linkedIn).toBe(true);
    expect(require('../dist').browser.inApp).toBe(true);
    jest.resetModules();
    uaGetter.mockReturnValue(UA.TwitterAppAndroid);
    expect(require('../dist').browser.twitter).toBe(true);
    expect(require('../dist').browser.inApp).toBe(true);
    jest.resetModules();
